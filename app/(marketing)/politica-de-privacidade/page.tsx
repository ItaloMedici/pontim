            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  A Pontim está comprometida com a proteção da sua privacidade e
                  dos seus dados pessoais. Esta Política de Privacidade explica
                  como coletamos, usamos, compartilhamos e protegemos suas
                  informações quando você usa nossa plataforma de Scrum Poker,
                  conforme as disposições da Lei Geral de Proteção de Dados
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                ...
                atendem aos requisitos da LGPD através de cláusulas contratuais
                adequadas.
              </p>
            </div>
