            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <strong>pontim.org</strong>), você concorda em cumprir e estar
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-gray-300 pl-6">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      Para utilizar certas funcionalidades, você deve criar uma
                      conta através do Google OAuth. Ao se cadastrar, você
                      declara que:
                    </p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Não oferecemos reembolsos para serviços já prestados, exceto
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                ...
                ininterrupto, seguro ou livre de erros. Nossa responsabilidade é
