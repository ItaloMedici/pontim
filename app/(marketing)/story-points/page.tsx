                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                      ...
                      relativa usada em metodologias ágeis para estimar o
                      esforço necessário para completar uma User Story ou
                      tarefa.
                    </p>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                      ...
                      completados em uma Sprint. Com o tempo, a equipe
                      estabelece uma velocidade média que permite planejamento
                      mais preciso.
                    </p>
              ...
              <div className="bg-black dark:bg-white rounded-3xl p-8 md:p-12 text-center text-white dark:text-black">
                <div className="max-w-3xl mx-auto">
                  ...
                  <p className="text-xl text-gray-300 dark:text-gray-600 mb-8 leading-relaxed">
                    Use diferentes escalas de Story Points durante suas sessões
                    de Planning Poker com Fibonacci, T-shirt sizing e escalas
                    personalizadas.
                  </p>
                  <motion.a
                    href="/login"
